# Generated by Django 4.2.6 on 2025-09-02 03:54
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profil_valide', models.BooleanField(default=False, help_text='Le profil a-t-il été validé par un administrateur ?')),
                ('date_validation_profil', models.DateTimeField(blank=True, help_text='Date de validation du profil', null=True)),
            ],
            options={
                'verbose_name': 'Membre',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField()),
                ('date_debut', models.DateField()),
                ('statut', models.CharField(choices=[('in_progress', 'In Progress'), ('completed', 'Completed'), ('suspended', 'Suspended'), ('cancelled', 'Cancelled')], default='en_cours', max_length=20)),
        ...
        migrations.AddField(
            model_name='membre',
            name='theme',
            field=models.ForeignKey(blank=True, help_text='Thème principal (obsolète)', null=True, on_delete=django.db.models.deletion.SET_NULL, to='labo.theme'),
        ),
        migrations.AddField(
            model_name='membre',
            name='themes',
            field=models.ManyToManyField(blank=True, help_text='Thèmes de recherche du membre', related_name='membres', to='labo.theme'),
        ),
        migrations.AddField(
            model_name='membre',
            name='user',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, help_text='Administrateur qui a validé le profil', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='profils_valides', to=settings.AUTH_USER_MODEL),
        ),
        migrations.CreateModel(
            name='Invitation',
            fields=[
